...
class ReportEditView extends GetView<ReportEditController> {
  ...
  Widget _buildDropDownButtonHouseType() {
    return Obx(
        ...
        value: null,
        hint: Text(
          controller.houseTypeName.isNotEmpty ? controller.houseTypeName.value : 'Select furniture',
          style: TextStyle(color: Colors.black),
        ),
        underline: SizedBox(),
        iconSize: 0,
